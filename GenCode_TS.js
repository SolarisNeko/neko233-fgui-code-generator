...
function genCodeTs(handler) {
    ...
    let isThree = myProjectType == csharp_1.FairyEditor.ProjectType.ThreeJS;
    const isCocosCreatorProject = myProjectType == csharp_1.FairyEditor.ProjectType.CocosCreator;
    // 如果指定了 packageName
