...
// 自定义的生成代码逻辑
function genCodeCs(handler: FairyEditor.PublishHandler) {
    ...
    const isUnityProject: boolean = myProjectType == FairyEditor.ProjectType.Unity;
